SELECT 
    ...
    SUM(CASE
            WHEN ca.supervisor = FALSE AND ca.extend_agent IN ('agent',NULL) THEN 1
            ELSE 0
...
WHERE 
    ca.application NOT IN (SELECT application FROM raw.master_testing_demo_account mtda) or ca.application != '66345cae5afdcd001a7c4bd2'
GROUP BY 
    ca.application, 
    u.full_name, 
    b.billing_date, 
